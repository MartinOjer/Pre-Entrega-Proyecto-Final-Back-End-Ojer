...
app.get('/', (req, res) => {
  res.json({ mensaje: 'API REST - Sistema de Gestión de Taller - Node.js funcionando correctamente desde la URL: /' });
});
...
// import { auth } from './src/middleware/auth.middleware.js'; // NO LO COLOCO ACA A AUTH LO LLEVO A LA RUTA DEL EQUIPO, ESTA ES OTRA OPCION

// Importamos el enrutador de la autenticacion, donde definimos las rutas relacionadas con "auth"
import authRouter from './src/routes/auth.router.js';

// Asignamos el router de auth al prefijo '/api/auth'
// Esto significa que todas las rutas dentro de auth.router.js comenzarán con ese prefijo

// app.use('/api/auth', authRouter);
app.use('/api/auth', authRouter); // NO COLOCAR ACA EL AUTH ANTES DEL AUTHROUTER porque estaria diciendo que el login tiene que estar autorizado.
...
//=======================================================
// IMPORTACION DE RUTAS - Todas las rutas relacionadas con "equipments"
// ======================================================

// Importamos el enrutador de equipments (antes products), donde definimos las rutas relacionadas con "equipments"
// Usamos rutas separadas para mantener el código modular y organizado
import equipmentsRouter from './src/routes/equipments.router.js';

// Asignamos el router de equipments al prefijo '/api/equipments'
// Esto significa que todas las rutas dentro de equipments.router.js comenzarán con ese prefijo

app.use('/api/equipments', equipmentsRouter);
// app.use('/api/equipments', auth, equipmentsRouter); // NO LO COLOCO ACA A AUTH LO LLEVO A LA RUTA DEL EQUIPO, ESTA ES OTRA OPCION
...
║     • POST   /api/equipments          [🔒 Auth requerido]      ║
║     • PUT    /api/equipments/:id      [🔒 Auth requerido]      ║
║     • DELETE /api/equipments/:id      [🔒 Auth requerido]      ║
║                                                                ║
╚════════════════════════════════════════════════════════════════╝
  `);
});
